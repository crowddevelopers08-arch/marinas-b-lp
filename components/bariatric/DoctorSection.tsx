      ...
      <div className="wrap">
        <div className="doc-grid">
          ...
          <div>
            ...
            <p className="doc-bio">Over 12 years, Dr.Preethi Mrinalini has helped patients struggling with obesity understand their medical options and achieve lasting results through advanced laparoscopic bariatric procedures with a focus on safety, metabolic outcomes, and long-term patient support.</p>
